...
const Faq = () => {
    return (
        <div className='max-w-11/12 mx-auto md:max-w-[1300px] md:mx-auto'>
            ...
            {/* 1 */}
            <div className='mt-11  mb-11 p-3 rounded-3xl bg-gray-50 border-1 border-gray-200'>
            ...
            {/* 2 */}
            <div className='mb-11  mt-5 p-3 rounded-3xl bg-gray-50 border-1 border-gray-200'>
