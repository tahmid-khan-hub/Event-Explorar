...
const UpcomingEvents = () => {
    ...
    return (
        ...
        <>
            ...
            <button className='btn md:ml-[45%] lg:ml-[47%] mt-11 ml-2 text-white bg-gradient-to-r from-purple-400 to-purple-500 hover:from-purple-500 hover:to-purple-600' onClick={()=> {
